...
return [
    ...
    */
    ...
    | especificar una línea de idioma personalizada específica para una regla de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para intercambiar nuestro placeholder de atributo
    | con algo más legible, como "Dirección de Email" en lugar de "email". Esto simplemente nos ayuda a hacer nuestros mensajes más expresivos.
    |
    */
